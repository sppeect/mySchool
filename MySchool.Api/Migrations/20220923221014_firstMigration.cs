        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressNeighborhood = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassRoom_ClassTypes_TypesId",
                        column: x => x.TypesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeachersClassRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeachersClassRooms_ClassRoom_ClassRoomId",
                        column: x => x.ClassRoomId,
                        principalTable: "ClassRoom",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeachersClassRooms_Teachers_TeachersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsClassRoom", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentsClassRoom_ClassRoom_ClassRoomId",
                        column: x => x.ClassRoomId,
                        principalTable: "ClassRoom",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentsClassRoom_ClassRoomId",
                table: "StudentsClassRoom",
                column: "ClassRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentsClassRoom_StudentsId",
                table: "StudentsClassRoom",
                column: "StudentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachersClassRooms_TeachersId",
                table: "TeachersClassRooms",
                column: "TeachersId");
        }
